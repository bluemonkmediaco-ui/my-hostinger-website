            ...
            <div style="display:grid;grid-template-columns:180px 1fr;gap:1.25rem;align-items:start;">
              ...
              <div style="display:flex;flex-direction:column;gap:0.4rem;align-items:center;">
                <div style="${aspectStyle}width:100%;background:#020617;border-radius:6px;overflow:hidden;border:1px solid rgba(0,210,255,0.3);display:flex;align-items:center;justify-content:center;">
                  ${vid.thumbnail
                    ? `<img src="${vid.thumbnail}" style="width:100%;height:100%;${(vid.videoUrl && (vid.videoUrl.includes('youtube') || vid.videoUrl.includes('youtu.be'))) ? 'object-fit:contain;background:#000;' : 'object-fit:cover;'}" onerror="this.onerror=null;this.src='https://via.placeholder.com/300x533/0b1528/38bdf8?text=Video+Cover';">`
                    : vid.path && vid.path.endsWith('.mp4')
                      ...
                      : vid.path
                        ? `<img src="${vid.path}" style="width:100%;height:100%;${(vid.videoUrl && (vid.videoUrl.includes('youtube') || vid.videoUrl.includes('youtu.be'))) ? 'object-fit:contain;background:#000;' : 'object-fit:cover;'}" onerror="this.onerror=null;this.src='https://via.placeholder.com/300x533/0b1528/38bdf8?text=Video+Cover';">`
                      ...
                      return `
                        <div class="thumb-frame-card ${isSelected ? 'selected' : ''}" 
                          ...
                          <div style="aspect-ratio:16/9;background:#0f172a;border-radius:4px;overflow:hidden;margin-bottom:0.3rem;display:flex;align-items:center;justify-content:center;">
                            <img src="${opt.url}" alt="${opt.label}" style="width:100%;height:100%;${(vid.videoUrl && (vid.videoUrl.includes('youtube') || vid.videoUrl.includes('youtu.be'))) ? 'object-fit:contain;background:#000;' : 'object-fit:cover;'}" onerror="this.onerror=null;this.src='https://via.placeholder.com/300x533/0b1528/38bdf8?text=Video+Cover';">
                          </div>
